...
const createPlanSchema = z.object({
  ...
  aiTokenLimit: z.number().int().positive().nullable().optional(),
  aiTokenDailyLimit: z.number().int().positive().nullable().optional(),
  aiTokenMonthlyLimit: z.number().int().positive().nullable().optional(),
  documentDraftingMonthlyLimit: z.number().int().positive().nullable().optional(),
  workspaceFolderFileLimit: z.number().int().positive().nullable().optional(),
