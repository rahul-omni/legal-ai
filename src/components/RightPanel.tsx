        ...
        <div className="flex gap-4">
          <button
            ...
            className={`px-4 py-2 text-sm rounded-lg transition-colors flex-1
                      ${activeTab === 'templates' 
                        ? 'bg-blue-50 text-blue-600/90' 
                        : 'text-gray-600/80 hover:bg-gray-200/70'}`}
          >
          ...
          >
            <AlertOctagon className="w-4 h-4 mr-2 inline-block" />
      ...
      <div className="flex-1 overflow-y-auto p-4 bg-[#f9f9f9]">
        {activeTab === 'templates' ? (
          ...
          <div className="space-y-3">
            {risks.length === 0 ? (
              <div className="text-center text-gray-500/80 py-8">
              ...
              risks.map((risk, index) => (
                ...
                >
                  <h3 className="font-medium text-amber-800/80">
