...
export function SearchForm({ searchParams, setSearchParams, isLoading, onSearch, errors }: SearchFormProps) {
  ...
  function getCaseTypesForBench1(bench: string) {
    switch(bench) {
      ...
      case "Allahabad High Court":
        return Object.keys(ALLAHABAD_HIGH_COURT_ALLAHABAD_HIGH_COURT_CASE_TYPES_VALUE_MAPPING);
      default:
        return [];
    }
  }
