...
const Button = React.forwardRef<HTMLButtonElement, ButtonProps>(
  ({ 
    ...
    const sizes = {
      sm: "px-2 py-1 text-xs gap-1 sm:px-3 sm:py-1.5 sm:text-sm sm:gap-1.5",
      md: "px-3 py-1.5 text-sm gap-1.5 sm:px-4 sm:py-2 sm:text-sm sm:gap-2",
      lg: "px-4 py-2 text-sm gap-2 sm:px-6 sm:py-3 sm:text-base sm:gap-2"
    };
